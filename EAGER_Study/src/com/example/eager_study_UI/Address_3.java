...
public class Address_3 extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.address_3);
	...
	public void next_button(View view){
		Intent adddressIntent = new Intent(this,Address_4.class);
	...
	public void lat_lng_button(View view){
        ...
        locationAddress.getAddressFromLocation(address, getApplicationContext(), new GeocoderHandler(), 3);
	   }
