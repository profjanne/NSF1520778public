...
public class IAT_1a extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.iat_1a);
	
		nextActivity = IAT_1a2.class;
		...
		self_text = (TextView) findViewById(R.id.textView4);
		self_text.setText(first_name);
		others_text = (TextView) findViewById(R.id.textView6);
		String others = "";
		for (int i=0; i<other_words.length-1; i++){
			others = others + other_words[i]+", ";
		}
		others = others + other_words[other_words.length-1];
		others_text.setText(others);
