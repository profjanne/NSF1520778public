...
public class QuestionsDataSource {
	...
	private String getUserID(Context ctx){
		settings=ctx.getSharedPreferences("TEST", 0);
	...
	public void createQuestionB(Question tempQuestion) {
		...
		createQuestion(activity,question,answer,date,time);
	}



	private void createQuestion(String activity, String question, String answer,String date, String time) {
